        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Zip = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    State = table.Column<string>(type: "nvarchar(16)", maxLength: 16, nullable: true),
                    AltContactName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    AltPhoneNumber = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    ...
                    Mileage = table.Column<string>(type: "nvarchar(7)", maxLength: 7, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PolicyNumber = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    VinNumber = table.Column<string>(type: "nvarchar(13)", maxLength: 13, nullable: false),
                    Tag = table.Column<string>(type: "nvarchar(13)", maxLength: 13, nullable: false),
                    Mileage = table.Column<string>(type: "nvarchar(7)", maxLength: 7, nullable: false),
                    ReferralNumber = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AltAddress = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    AltAddress2 = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    AltCity = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    AltZip = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    AltState = table.Column<string>(type: "nvarchar(16)", maxLength: 16, nullable: true),
                    AltContactName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    AltPhoneNumber = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    UserId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LaborPrice = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
                    SparePartsPrice = table.Column<decimal>(type: "decimal(18,4)", nullable: false),
                    Remarks = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
