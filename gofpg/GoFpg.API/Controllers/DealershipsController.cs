...
namespace GoFpg.API.Controllers
{
    public class DealershipsController : Controller
    {
        ...
        public DealershipsController(DataContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Dealer,ServicePhone,PartsPhone,Address")] Dealership dealership)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Dealer,ServicePhone,PartsPhone,Address")] Dealership dealership)
        {
            if (id != dealership.Id)
            {
                return NotFound();
